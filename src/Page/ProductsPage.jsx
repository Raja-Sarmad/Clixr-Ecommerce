      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-14 text-center">
          <h1 className="text-5xl md:text-7xl font-black tracking-tighter uppercase leading-tight">
            Art <span className="text-[#0b6472]">Gallery</span>
          </h1>
            ...
            {paintings.map((art, i) => (
              ...
              >
                <motion.div
                  ...
                  className="bg-[#0c0c0c] border border-white/5 rounded-2xl overflow-hidden hover:border-[#0b6472]/60 transition-all duration-400 hover:shadow-lg hover:shadow-[#0b6472]/10"
                >
                  {/* Image Section */}
                  ...
                  <div className="p-4">
                    ...
                    <div className="flex items-center justify-between border-t border-white/5 pt-3">
                      ...
                      {/* View Details Button */}
                      <span className="text-[10px] font-bold text-white bg-[#0b6472] px-3.5 py-1.5 rounded-full hover:bg-[#0d7a8a] hover:scale-105 transition-all uppercase shrink-0">
                        View
                      </span>
                    </div>
                  </div>
