...
export default function Hero() {
  ...
  const logos = useMemo(
    () => [
      "Acrylic","Watercolor","Oil Paint","Canvas Art","Handmade","Abstract","Modern Art","Fine Art",
      "Creative","Brushwork","Gallery","Art Studio","Painting","Artwork","Canvas","Acrylic","Watercolor",
      "Oil Paint","Abstract","Fine Art","Creative","Gallery","Painting","Artwork","Canvas","Brushwork",
      "Modern Art","Handmade","Art Studio","Creative"
    ],
    []
  );
  ...
  return (
    ...
    >
      <div className="relative z-10 flex flex-col items-center text-center px-4 w-full max-w-[1400px]">
        ...
        <h1
          className={`text-[55px] md:text-[clamp(60px,8vw,120px)] font-semibold leading-[1] tracking-[-1px] md:tracking-[-2px] text-white transition-all duration-300 ${
