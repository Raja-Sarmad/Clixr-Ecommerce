  ...
  return (
    ...
    >
      ...
      <div ref={textRef} className="flex flex-col items-center text-center mt-10 md:-mt-20 z-20">
        <h1 className="text-white text-5xl sm:text-6xl md:text-8xl font-bold leading-tight md:leading-none tracking-tighter">
          Real
        </h1>
        <h1 className="text-[#555] text-5xl sm:text-6xl md:text-8xl font-bold leading-tight md:leading-none tracking-tighter">
          Potential
        </h1>
